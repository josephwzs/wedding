...
import { Form } from 'src/app/common/base/form';
import { User } from 'src/app/common/sign-up/model/User';
import { CardComponent } from 'src/app/common/sign-up/card/card.component';
import { StringService } from 'src/app/common/base/string.service';
import { ActivatedRoute, Route } from '@angular/router';
import { CardComponent as CardComponent_1 } from '../../../common/sign-up/card/card.component';
...
@Component({
    ...
    standalone: true,
    imports: [BaseFormComponent, ReactiveFormsModule, FormFieldInputComponent, NgFor, CardComponent_1]
})
export class UserDetailComponent extends Form<User> implements OnInit {
